...
void OrdenaBolha(void *lista, int tam, int size, FuncaoCompara comp){
	int troca = 1, c;
...
int main (){
	...
	OrdenaBolha(aluno, tam, sizeof(Aluno), CompNome);
	ImprimelistaAlunos(aluno, tam);

	OrdenaBolha(aluno, tam, sizeof(Aluno), CompMedia);
	ImprimelistaAlunos(aluno, tam);
